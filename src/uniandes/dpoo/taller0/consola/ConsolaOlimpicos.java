...
public class ConsolaOlimpicos
{
	...
	/**
	 * Este metodo le pide al usuario el nombre de un atleta
	 * para luego imprimir en consola a que pais pertenece.
	 */
	private void ejecutarPaisDeAtleta() {
		String nombreAtleta = input("Ingrese el nombre del atleta");
		
		String paisAtleta = calculadora.buscarPaisDeAtleta(nombreAtleta);
		
		System.out.println("El pais de " + nombreAtleta + " es: " + paisAtleta);
	}
