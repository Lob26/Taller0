...
public class CalculadoraEstadisticas
{
	...
	/**
	 * @param pNombreAtleta : El nombre del atleta
	 * 
	 * @return String con el pais al que pertenece el atleta, "None" si no hay
	 */
	public String buscarPaisDeAtleta(String pNombreAtleta) {
		
		Atleta pAtleta = buscarAtleta(pNombreAtleta);
		
		return (pAtleta != null)
				? pAtleta.darPais().darNombre()
				: "None";
	}
